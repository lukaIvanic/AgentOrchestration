...
from src.common.metrics_policy import validate_manifest_metrics
...
def cli():
    ...
    if args.command == "init":
        ...
        violations = validate_manifest_metrics(manifest)
        if violations:
            print(
                "Deploy blocked: metrics label cardinality policy failed",
                file=sys.stderr,
            )
        ...
        print("Metrics label cardinality check passed")
