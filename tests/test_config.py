...
class TestConfig:
    ...
    def test_env_override_false_is_boolean_false(self, monkeypatch):
    ...
    def test_env_override_true_is_boolean_true(self, monkeypatch):
    ...
    def test_env_override_non_boolean_string_is_unchanged(self, monkeypatch):
